...
gSfiles[] fillarray "/Users/j/Documents/PROJECTs/_utils/stereo.wav", "/Users/j/Documents/PROJECTs/_utils/stereo.wav"
gScsound_score init "/Users/j/Desktop/1.txt"
ipole_ord   init 24
...
if kgate == 1 then
    ...
    schedulek 2, isec_gate/2, $dur_event, ich, kdyn
    kgate = 0
endif
...
idone	system_i 1, sprintf("echo \'%s, %f, %f, %f, %i, %f\' >> %s.txt", Sinstr, itime, idur, idyn, ienv, icps, gScsound_score)
    schedule 3, 0, idur, idyn, ich, icps
