...
instr ---NAME---
	...
	until ivoice == ivoices do
		...
		;inum	init nstrnum("---NAME---_phase_bend")+idec/1000
		schedule "---NAME---_phase_bend", 0, idur, idyn, ienv, icps, ich, ivoice, ivoices
		ivoice += 1
	od
	turnoff
...
instr ---NAME---_phase_bend
	...
	ivar				pow 2, 10
	aphasor_phase		phasor icps / (ivar + jitter(ivar-.5, 1/24, 1/8)), iphase
	aphase				table3 aphasor_phase, ienv, 1

	aphasor				= (aphasor+iphase*aphase)%1
