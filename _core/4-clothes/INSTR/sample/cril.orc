gScril_file 		 init "/Users/j/Documents/PROJECTs/CORDELIA/samples/cril.wav"
gicril_chs 		 init 2
;-------
gicril_1		 ftgen 0, 0, 0, 1, gScril_file, 0, 0, 1
gicril_2		 ftgen 0, 0, 0, 1, gScril_file, 0, 0, 2
;-------
gkcril_time		init 16
gkcril_off		init .005
gkcril_dur		init 1
...
if imode == is_opcode then
	...
	itab	init ich%gicril_chs
	aout	tablei aph, gicril_1+(itab), 1
...
if 	hex("8", gkcril_time) == 1 then

	if kndx == imax+1 then
		kndx = 1
	endif

	kdur	= gkbeats*gkcril_dur
