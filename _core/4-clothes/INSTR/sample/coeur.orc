gScoeur_file 		 init "/Users/j/Documents/PROJECTs/CORDELIA/samples/coeur.wav"
gicoeur_chs 		 init 2
;-------
gicoeur_1		 ftgen 0, 0, 0, 1, gScoeur_file, 0, 0, 1
gicoeur_2		 ftgen 0, 0, 0, 1, gScoeur_file, 0, 0, 2
;-------
...
if imode == is_opcode then
	...
	itab	init ich%gicoeur_chs
	aout	tablei aph, gicoeur_1+(itab), 1
