...
gishinobi_chs 		 init 2
;-------
gishinobi_1		 ftgen 0, 0, 0, 1, gSshinobi_file, 0, 0, 1
gishinobi_2		 ftgen 0, 0, 0, 1, gSshinobi_file, 0, 0, 2
;-------
...
if imode == is_opcode then
	...
	itab	init ich%gishinobi_chs
	aout	tablei aph, gishinobi_1+(itab), 1
