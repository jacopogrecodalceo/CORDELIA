gSmaison_file 		 init "/Users/j/Documents/PROJECTs/CORDELIA/samples/maison.wav"
gimaison_chs 		 init 2
;-------
gimaison_1		 ftgen 0, 0, 0, 1, gSmaison_file, 0, 0, 1
gimaison_2		 ftgen 0, 0, 0, 1, gSmaison_file, 0, 0, 2
;-------
gkmaison_time		init 16
gkmaison_off		init .005
gkmaison_dur		init 1
;-------
...
if imode == is_opcode then
	...
	itab	init ich%gimaison_chs
	aout	tablei aph, gimaison_1+(itab), 1
...
if 	hex("8", gkmaison_time) == 1 then

	if kndx == imax+1 then
		kndx = 1
	endif

	kdur	= gkbeats*gkmaison_dur
