gSleo_file 		 init "/Users/j/Documents/PROJECTs/CORDELIA/samples/leo.wav"
gileo_chs 		 init 2
;-------
gileo_1		 ftgen 0, 0, 0, 1, gSleo_file, 0, 0, 1
gileo_2		 ftgen 0, 0, 0, 1, gSleo_file, 0, 0, 2
;-------
gkleo_time		init 16
gkleo_off		init .005
gkleo_dur		init 1
...
if imode == is_opcode then
	...
	itab	init ich%gileo_chs
	aout	tablei aph, gileo_1+(itab), 1
...
if 	hex("8", gkleo_time) == 1 then

	if kndx == imax+1 then
		kndx = 1
	endif

	kdur	= gkbeats*gkleo_dur
