...
ginovember_chs 		 init 2
;-------
ginovember_1		 ftgen 0, 0, 0, 1, gSnovember_file, 0, 0, 1
ginovember_2		 ftgen 0, 0, 0, 1, gSnovember_file, 0, 0, 2
;-------
...
if imode == is_opcode then
	...
	itab	init ich%ginovember_chs
	aout	tablei aph, ginovember_1+(itab), 1
