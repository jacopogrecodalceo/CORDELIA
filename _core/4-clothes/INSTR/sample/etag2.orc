gSetag2_file 		 init "/Users/j/Documents/PROJECTs/CORDELIA/samples/etag2.wav"
gietag2_chs 		 init 4
;-------
gietag2_1		 ftgen 0, 0, 0, 1, gSetag2_file, 0, 0, 1
gietag2_2		 ftgen 0, 0, 0, 1, gSetag2_file, 0, 0, 2
gietag2_3		 ftgen 0, 0, 0, 1, gSetag2_file, 0, 0, 3
gietag2_4		 ftgen 0, 0, 0, 1, gSetag2_file, 0, 0, 4
;-------
gketag2_time		init 16
gketag2_off		init .005
gketag2_dur		init 1
;-------
...
if imode == is_opcode then
	...
	itab	init ich%gietag2_chs
	aout	tablei aph, gietag2_1+(itab), 1
...
if 	hex("8", gketag2_time) == 1 then

	if kndx == imax+1 then
		kndx = 1
	endif

	kdur	= gkbeats*gketag2_dur
