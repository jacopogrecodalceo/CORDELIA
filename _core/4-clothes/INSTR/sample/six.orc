gSsix_file 		 init "/Users/j/Documents/PROJECTs/CORDELIA/samples/six.wav"
gisix_chs 		 init 4
;-------
gisix_1		 ftgen 0, 0, 0, 1, gSsix_file, 0, 0, 1
gisix_2		 ftgen 0, 0, 0, 1, gSsix_file, 0, 0, 2
gisix_3		 ftgen 0, 0, 0, 1, gSsix_file, 0, 0, 3
gisix_4		 ftgen 0, 0, 0, 1, gSsix_file, 0, 0, 4
;-------
gksix_time		init 16
gksix_off		init .005
gksix_dur		init 1
...
if imode == is_opcode then
	...
	itab	init ich%gisix_chs
	aout	tablei aph, gisix_1+(itab), 1
