gSarm1_file 		 init "/Users/j/Documents/PROJECTs/CORDELIA/samples/arm1.wav"
giarm1_chs 		 init 2
;-------
giarm1_1		 ftgen 0, 0, 0, 1, gSarm1_file, 0, 0, 1
giarm1_2		 ftgen 0, 0, 0, 1, gSarm1_file, 0, 0, 2
;-------
gkarm1_time		init 16
gkarm1_off		init .005
gkarm1_dur		init 1
...
if imode == is_opcode then
	...
	itab	init ich%giarm1_chs
	aout	tablei aph, giarm1_1+(itab), 1
