...
giplanche_chs 		 init 2
;-------
giplanche_1		 ftgen 0, 0, 0, 1, gSplanche_file, 0, 0, 1
giplanche_2		 ftgen 0, 0, 0, 1, gSplanche_file, 0, 0, 2
;-------
...
if imode == is_opcode then
	...
	itab	init ich%giplanche_chs
	aout	tablei aph, giplanche_1+(itab), 1
