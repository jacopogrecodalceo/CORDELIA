gSgesto1var_file 		 init "/Users/j/Documents/PROJECTs/CORDELIA/samples/gesto1var.wav"
gigesto1var_chs 		 init 2
;-------
gigesto1var_1		 ftgen 0, 0, 0, 1, gSgesto1var_file, 0, 0, 1
gigesto1var_2		 ftgen 0, 0, 0, 1, gSgesto1var_file, 0, 0, 2
;-------
gkgesto1var_time		init 16
gkgesto1var_off		init .005
gkgesto1var_dur		init 1
;-------
...
if imode == is_opcode then
	...
	Sinstr		init "gesto1var"
	idur		init p3
	iamp		init p4
	idiv		init p5%i(gksamp_mod)
	ix			init p6
	ich			init p7
	ioff		i gkgesto1var_off
	...
	itab	init ich%gigesto1var_chs
	aout	tablei aph, gigesto1var_1+(itab), 1
...
if 	hex("8", gkgesto1var_time) == 1 then

	if kndx == imax+1 then
		kndx = 1
	endif

	kdur	= gkbeats*gkgesto1var_dur
