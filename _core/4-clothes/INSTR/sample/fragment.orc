...
gifragment_chs 		 init 2
;-------
gifragment_1		 ftgen 0, 0, 0, 1, gSfragment_file, 0, 0, 1
gifragment_2		 ftgen 0, 0, 0, 1, gSfragment_file, 0, 0, 2
;-------
...
if imode == is_opcode then
	...
	itab	init ich%gifragment_chs
	aout	tablei aph, gifragment_1+(itab), 1
