...
gitension_chs 		 init 2
;-------
gitension_1		 ftgen 0, 0, 0, 1, gStension_file, 0, 0, 1
gitension_2		 ftgen 0, 0, 0, 1, gStension_file, 0, 0, 2
;-------
...
if imode == is_opcode then
	...
	itab	init ich%gitension_chs
	aout	tablei aph, gitension_1+(itab), 1
