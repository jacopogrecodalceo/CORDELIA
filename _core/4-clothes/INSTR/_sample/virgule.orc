...
givirgule_chs 		 init 2
;-------
givirgule_1		 ftgen 0, 0, 0, 1, gSvirgule_file, 0, 0, 1
givirgule_2		 ftgen 0, 0, 0, 1, gSvirgule_file, 0, 0, 2
;-------
...
if imode == is_opcode then
	...
	itab	init ich%givirgule_chs
	aout	tablei aph, givirgule_1+(itab), 1
