gSnasa_file 		 init "/Users/j/Documents/PROJECTs/CORDELIA/samples/nasa.wav"
ginasa_chs 		 init 1
;-------
ginasa_1		 ftgen 0, 0, 0, 1, gSnasa_file, 0, 0, 1
;-------
gknasa_time		init 16
gknasa_off		init .005
gknasa_dur		init 1
...
if imode == is_opcode then
	...
	itab	init ich%ginasa_chs
	aout	tablei aph, ginasa_1+(itab), 1
...
if 	hex("8", gknasa_time) == 1 then

	if kndx == imax+1 then
		kndx = 1
	endif

	kdur	= gkbeats*gknasa_dur
