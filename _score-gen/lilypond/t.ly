...
<<
	\new Staff = cordelia \repeat unfold 16 { \textMark "hello there" s1 \break }
	\new Staff = goneril \repeat unfold 16 { s1 \break }
	\new Staff = regan \repeat unfold 16 { s1 \break }
	%\cadenzaOn

	\context Staff = goneril \new Voice \after 4 a'1 \- ^\markup {
	\general-align #Y #DOWN {
		\epsfile #Y #12 #"/Users/j/Documents/PROJECTs/_METHOD/_notation/_LILYPOND/exemple-proportional_notation/armagain.eps"
	}}
