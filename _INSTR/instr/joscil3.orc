...
gSjoscil3_path init "/Users/j/Documents/PROJECTs/CORDELIA/_INSTR/sonvs/samps-joscil3"
...
$start_instr(joscil3)
	...
	; joscil3-1  to 21
	Spath sprintf "%s/joscil3-%i.wav", gSjoscil3_path, irootnote
	...
	if idur >= ilen then
		...
		acoda		diskgrain Spath, 1, igr_freq*(1+oscili:k(1, gkbeatf*4)), ipitch, igr_size, -ips*istr, gihanning, iolaps
