...
gSfpianos_path init "/Users/j/Documents/PROJECTs/CORDELIA/_INSTR/sonvs/samps-kawai_felt"
...
elseif inote <= 127 && inote > 85 then
	...
	Spath sprintf "%s/Felt_Piano_%s_%s_RR%i.wav", gSfpianos_path, Sdyn, Snote_name, int(random:i(1, 3))

	; RELEASE
	;================================================================
	Spath_release sprintf "%s/Felt_Piano_Release_%s.wav", gSfpianos_path, Snote_name
	schedule "fpianos_release", p3, filelen(Spath_release), Spath_release, ich
	;================================================================
