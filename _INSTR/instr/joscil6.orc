...
gSjoscil6_path init "/Users/j/Documents/PROJECTs/CORDELIA/_INSTR/sonvs/samps-joscil6"
...
$start_instr(joscil6)
	...
	; joscil6-1  to 21
	Spath sprintf "%s/joscil6-%i.wav", gSjoscil6_path, irootnote
	...
	if idur >= ilen then
		...
		a1, a2		diskgrain Spath, 1, igr_freq*(1+oscili:k(1, (gkbeatf*4)+1/4)), ipitch, igr_size, -ips*istr, gihanning, iolaps
		a3, a4		diskgrain Spath, 1, igr_freq*(1+oscili:k(1, gkbeatf*4)), ipitch, igr_size, -ips*istr, gihanning, iolaps
	...
	aout moogladder2 aout*$dyn_var, limit(20$k-((1-$dyn_var)*15.5$k)+icps*idyn, 50, 20$k), random:i(0, 1/9)
	$dur_var(10)
$end_instr
