...
;		INSTR 2
ainstr2_1		oscil3 $dyn_var, icps*random:i(1.995, 2.005)*2, gisaw
ainstr2_2		oscil3 $dyn_var, icps*random:i(1.995, 2.005)*4, gisaw
...
#define 	wendjvib2 #abs(oscil3(1, cosseg(random(.5, 1)/iatk, idur, random(5, 45)/irel), gisine))#

ainstr2_out		= ainstr2_out * linseg(0, iatk, 1, idec, isus, irel, 0) * $wendjvib2

;		INSTR 3
ainstr3_out		oscil3 $dyn_var, icps*random:i(1.995, 2.005)/2, gitri
ainstr3_out		*= cosseg:a(1, idur/(3+gauss(.25)), 0)
