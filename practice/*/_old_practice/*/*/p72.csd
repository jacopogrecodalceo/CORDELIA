...
if (eu(6, 12, circle(4, fillarray(16, 16*2, 4, 36))) == 1) then
	edrum("HH/open/XF_HatAna51.wav",
	.15,
	kch)
elseif (eu(6, 16, 16) == 1) then
	edrum("HH/open/XF_HatAna35.wav",
	.15,
	kch * .25)
...
if (eu(7, 16, circle(4, fillarray(4, 8, 6, 4))) == 1) then
	edrum("/Analog Kicks/XF_Kick_A_003.wav",
	.5,
	$ff,
	random:k(.05, 1))
...
elseif (eu(9, 16, 6) == 1) then
	edrum("/Analog Kicks/XF_Kick_A_009.wav",
	1,
	$mf,
	random:k(.05, 1))
elseif (eu(4, 16, 8) == 1) then
	edrum("/Analog Kicks/XF_Kick_A_011.wav",
	1,
	$f,
	random:k(.05, 1))
endif
...
routemeout("Juliet", "Twinkle", .5)


;getmeout("rePuck")
;getmeout("Puck")
getmeout("Drum")
routemeout("Drum", "Twinkle", .5)
