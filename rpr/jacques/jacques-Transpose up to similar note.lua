...
-- Dependency Name
local script = "Transpose to similar note-functions.lua" -- 1. The target script path relative to this file. If no folder, then it means preset file is right to the target script.
...
local function main()
	...
	for _, note in ipairs(selected_notes) do
		...
		local factor = find_transposition_up(tuning, note)
