...
def main():
	...
	lines.append(f'\tschedule 1, {proj_len}, .025')
	...
	for i, instr in enumerate(instrs):
		includes.append(CORDELIA_INSTR_json[instr]['path'])
...
command = f'csound -3 --nchnls={chns} -r {sr} --ksmps={ksmps} --orc {ORC_FILE} -o {WAV_FILE}'
