...
local instr_dir = '/Users/j/Documents/PROJECTs/CORDELIA/rpr/cordelia_instruments/ATS'
local py_script = '/Users/j/Documents/PROJECTs/CORDELIA/rpr/exec_csound-ATS.py'
...
nchnls  = 2
		...
		if b_retval then
			...
			local output_file_orc = temp_dir .. basename .. '-ATS' .. unique_timestamp .. '.orc'
			write_file(output_file_orc, csound_code)
			MAIN_OUTPUT = temp_dir .. basename .. '-ATS' .. unique_timestamp .. '.wav'
