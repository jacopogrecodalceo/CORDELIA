...
local cheby_script = '/Users/j/Documents/PROJECTs/CORDELIA/cordelia_atsa/_gensyn-bychev.py'
...
--[[ 			local values = retvals_csv:gmatch('([^,]+)')
			...
			local destination_path = temp_dir .. basename .. '-bychev' .. generate_unique_timestamp() .. '.wav'
