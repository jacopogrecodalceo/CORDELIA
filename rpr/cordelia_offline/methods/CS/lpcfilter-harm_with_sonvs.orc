...
apost_in		sum ain, apre_in
apost_car		sum acar, apre_car

apost			sum apost_in*(.5+jitter:k(.5, 1/idur, 128/idur)), apost_car*(.5+jitter:k(.5, 1/idur, 128/idur))

aout			sum asum*16, adel*16, apost/128
