...
; *** READ ***
; ============
kread 			line gidur, p3, 0
kfreq, kdyn		ATSread kread, Satsfile, ipartial
adyn			a portk(kdyn, 1)
afreq			a portk(kfreq, 1)
...
avib1			= lfo(kfreq/128, kfreq/250)*abs(jitter(1, 1/idur, 100/idur))
...
a_filter_r		bqrez	a_sig_r, afreq+(afreq*(16*adyn)), abs(jitter(.65, .0015, .05))
