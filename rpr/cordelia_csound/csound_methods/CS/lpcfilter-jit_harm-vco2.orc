...
; CARRIER
; ────────────────────────────────────────────────────────────────────────────────────────────
acar1      	vco2 1/3, gkcps*(1+floor(table3:k(phasor:k(1/(8+jitter(.5, 1/idur, 3/idur))), giasine, 1)*6))
acar2      	vco2 1/3, gkcps*(1+floor(table3:k((.25+phasor:k(1/(8+jitter(.5, 1/idur, 3/idur)))%1), giasine, 1)*6))

acar		sum acar1*oscili:a(1, 5+jitter(.5, 1/idur, 3/idur), giasquare), acar2*oscili:a(1, 7+jitter(.5, 1/idur, 3/idur), giasquare, 1/4)
acar_hp		K35_hpf acar, 9500+jitter(3500, 1/idur, 3/idur), 4.5+jitter(1.5, 1/idur, 3/idur), 1, 1.5+jitter(.5, 1/idur, 3/idur)
