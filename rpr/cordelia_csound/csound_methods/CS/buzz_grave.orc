...
abuzz1      buzz 0dbfs, portk(kf0*2, abs(jitter(kport, 1/12, 1))), kn_harm, -1
abuzz2      buzz 0dbfs, portk(kf0_last*22/10, abs(jitter(kport, 1/12, 1))), kn_harm, -1

abuzz3      buzz 0dbfs, portk(kf0/4, abs(jitter(kport, 1/12, 1))), kn_harm, -1


asum    = abuzz1 + abuzz2 + abuzz3
