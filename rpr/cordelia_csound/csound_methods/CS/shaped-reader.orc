...
idur			init p3
; ============
gadur			= 125 + a(jitter:k(25, 1/idur, 3/idur))
gadur			/= 1000
; ============
...
aenv			table phasor:a(1/gadur, iphase), giWINDOW, 1

aout			table3 ( gastart*isamps + gadur*sr + a(jitter:k(ijitter_samps, 3.5, 5)) ) % isamps, ift
aout			*= aenv
aout			/= ivoices
	outch ich, aout
