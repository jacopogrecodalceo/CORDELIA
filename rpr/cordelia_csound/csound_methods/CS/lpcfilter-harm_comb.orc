...
acar1      	vco2 1/2, gkcps*(1+floor(table3:k(phasor:k(1/(8+jitter:k(.5, 1/idur, 3/idur))), giasine, 1)*6))
acar2      	vco2 1/2, gkcps*(1+floor(table3:k((.25+phasor:k(1/(8+jitter:k(.5, 1/idur, 3/idur)))%1), giasine, 1)*6))

acar		sum acar1, acar2
