...
opcode vocoder, a, aakkkik
	ain, acarrier, imin, imax, kq, inumbands, kdyn xin
	...
	abands_in_hp[], abands_in_lp[], abands_in_bp[], abands_in_br[] 							poly inumbands, "svn", ain*idyn, limit(ifreqs*(.25+kdyn*giDYN_factor), imin, imax), kq_arr, kdrive
	abands_in_hp, abands_in_lp, abands_in_bp, abands_in_br   								poly inumbands, "svn", abands_in_bp, ifreqs, kq_arr, kdrive
	
	abands_carrier_hp[], abands_carrier_lp[], abands_carrier_bp[], abands_carrier_br[] 		poly inumbands, "svn", acarrier*idyn, ifreqs, kq_arr, kdrive/24
	abands_carrier_hp, abands_carrier_lp, abands_carrier_bp, abands_carrier_br   			poly inumbands, "svn", abands_carrier_bp, ifreqs, kq_arr, kdrive/24

	abands[]    poly inumbands, "balance", abands_in_bp, abands_carrier_bp*idyn*32
...
aout        vocoder ain, aosc, \
			givoc_MIN, givoc_MAX, givoc_Q, givoc_BANDs, krms
